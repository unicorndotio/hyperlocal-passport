...
Use this template to structure every Product Requirements Document. Fill each
section based on brainstorming outcomes. Leave placeholder guidance in sections
where information is insufficient and note them in Open Questions.
...
Do NOT include implementation details such as specific databases, frameworks,
API designs, or architecture patterns.
...
Do NOT include technical risks such as architectural complexity or technical
debt.
