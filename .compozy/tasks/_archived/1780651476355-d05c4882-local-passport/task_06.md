...
Develop the visual dashboard where administrators can review pending resident
registrations, inspect uploaded documents, and approve or reject applications to
join the benefits club.
...
Use shadcn/ui components like Data Table, Dialog/Modal for the images, and
Buttons. Ensure the route requires an admin session.
